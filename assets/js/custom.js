...
function populateSeatingDropdown(selector) {
  $.getJSON("./assets/data/fleets.json?v=12", function (data) {
...
$(document).ready(function () {
  $.getJSON("./assets/data/tours.json?v=12", function (data) {
...
// Fetch the offers data from offers.json?v=12 and populate the carousel
$(document).ready(function () {
  $.getJSON('./assets/data/offers.json?v=12', function (offers) {
